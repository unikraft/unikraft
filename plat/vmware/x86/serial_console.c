...
#if CONFIG_VMWARE_SERIAL_BAUD_19200
#define COM1_BAUDDIV_LO 0x04
#elif CONFIG_VMWARE_SERIAL_BAUD_38400
#define COM1_BAUDDIV_LO 0x03
#elif CONFIG_VMWARE_SERIAL_BAUD_57600
#define COM1_BAUDDIV_LO 0x02
#else /* default, CONFIG_VMWARE_SERIAL_BAUD_115200 */
