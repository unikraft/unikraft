...
int kvm_coutd(const char *buf __maybe_unused, unsigned int len)
{
...
int kvm_coutk(const char *buf __maybe_unused, unsigned int len)
{
	for (unsigned int i = 0; i < len; i++) {
...
int kvm_cink(char *buf __maybe_unused, unsigned int maxlen __maybe_unused)
{
...
const struct uk_console_ops uk_console_kvm_ops = {
	.coutd = kvm_coutk,
	.coutk = kvm_coutk,
	.cink = kvm_cink,
