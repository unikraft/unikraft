...
MZ_PE_HDR = {
    ...
    "SizeOfOptionalHeader"       : (0x00000000000000f0, 0x02),  # Offset  84
    ...
    "NumberOfRvaAndSizes"        : (0x0000000000000010, 0x04),  # Offset 196

    # Optional Header Data Directories (Image Only)
    "Export Table"               : (0x0000000000000000, 0x08),  # Offset 206
    "Import Table"               : (0x0000000000000000, 0x08),  # Offset 214
    "Resource Table"             : (0x0000000000000000, 0x08),  # Offset 222
    "Exception Table"            : (0x0000000000000000, 0x08),  # Offset 230
    "Certification Table"        : (0x0000000000000000, 0x08),  # Offset 238
    "Base Relocation Table"      : (0x0000000000000000, 0x08),  # Offset 246
    "Debug"                      : (0x0000000000000000, 0x08),  # Offset 254
    "Architecture"               : (0x0000000000000000, 0x08),  # Offset 262
    "Global Ptr"                 : (0x0000000000000000, 0x08),  # Offset 270
    "TLSTable"                   : (0x0000000000000000, 0x08),  # Offset 278
    "Load Config Table"          : (0x0000000000000000, 0x08),  # Offset 286
    "Bound Import"               : (0x0000000000000000, 0x08),  # Offset 294
    "IAT"                        : (0x0000000000000000, 0x08),  # Offset 302
    "Delay Import Descriptor"    : (0x0000000000000000, 0x08),  # Offset 310
    "CLR Runtime Header"         : (0x0000000000000000, 0x08),  # Offset 318
    "Reserved, must be zero"     : (0x0000000000000000, 0x08),  # Offset 326

    # Section Table (Section Headers)
    "SectionHeaders"             : [ ]                          # Offset 334
}
...
def main():
    ...
    with open(opt.elf, 'r+b') as f:
        ...
        # Also add the fake .reloc section
        MZ_PE_HDR["NumberOfSections"][0] = len(ld_phdrs) + 1
        MZ_PE_HDR["ImageBase"][0] = base_addr
        MZ_PE_HDR["SizeOfHeaders"][0] = PE_SEC_SZ * (len(ld_phdrs) + 1)
        MZ_PE_HDR["SizeOfHeaders"][0] += 334  # See MZ_PE_HDR Offset comments
        ...
        MZ_PE_HDR["SectionHeaders"].append(
            {
                "Name"                : (0x2E72656C6F630000, 0x8),  # .reloc
                "VirtualSize"         : (0x0000000000000000, 0x4),
                "VirtualAddress"      : (     reloc_ptr    , 0x4),
                "SizeOfRawData"       : (0x0000000000000000, 0x4),
                "PointerToRawData"    : (     reloc_ptr    , 0x4),
                "PointerToRelocations": (0x0000000000000000, 0x4),
                "PointerToLinenumbers": (0x0000000000000000, 0x4),
                "NumberOfRelocations" : (0x0000000000000000, 0x2),
                "NumberOfLinenumbers" : (0x0000000000000000, 0x2),
                "Characteristics"     : (    PE_SEC_CHRS   , 0x4),
            }
        )
