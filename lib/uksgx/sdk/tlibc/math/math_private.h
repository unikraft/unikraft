...
/* 
*  bzero() is a Linux specific function and is required by nan() in math library. 
*  We import it as an internal function 
*/
void bzero(void *, size_t);

/* The following are "__BSD_VISIBLE" functions, but we need them. */
/*
