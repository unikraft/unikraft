...
set(LINK_FLAG_DYNAMIC_MACOSX "-dynamiclib")
...
set(LIBRARY_DEFINES "${LIBRARY_DEFINES} -D_APPLE_CLANG")
set(APPLE_CLANG ON)
set(APPLE_CLANG ${APPLE_CLANG} PARENT_SCOPE)
...
#Diagnostic flags
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wdouble-promotion -Wshadow -Wunreachable-code -Wpointer-arith -Wuninitialized")
