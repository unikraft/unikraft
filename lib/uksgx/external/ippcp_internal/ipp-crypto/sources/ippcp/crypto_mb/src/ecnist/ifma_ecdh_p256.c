...
*/
DLL_PUBLIC
mbx_status mbx_nistp256_ecdh_ssl_mb8(int8u* pa_shared_key[8],
                                     ...
                                     int8u* pBuffer)
{
   ...
   */
   ...
   status |= MBX_SET_STS_BY_MASK(status, is_zero(secretz, P256_LEN64+1), MBX_STATUS_MISMATCH_PARAM_ERR);
...
DLL_PUBLIC
mbx_status mbx_nistp256_ecdh_mb8(int8u* pa_shared_key[8],
                                 ...
                                 int8u* pBuffer)
{
   ...
   */
   ...
   P256_POINT P;
   /* set party's public */
   ifma_BNU_to_mb8((int64u (*)[8])P.X, (const int64u* (*))pa_pubx, P256_BITSIZE); // P-> crypto_mb radix 2^52
