...
void EXP52x20_mb8(int64u out[][8],
            const int64u base[][8],
            const int64u exp[][8],
            ...
            int64u work_buffer[][8])
{
   ...
   */
   ...
   for(idx=1; idx<(1<<EXP_WIN_SIZE)/2; idx++) {
      ...
      ifma_amm52x20_mb8((int64u*)red_table[2*idx+1], (int64u*)red_table[2*idx], (int64u*)red_table[1], (int64u*)modulus, (int64u*)k0);
   }
   ...
   /* exponentiation */
   {
      ...
      for(exp_bit_no-=EXP_WIN_SIZE; exp_bit_no>=0; exp_bit_no-=EXP_WIN_SIZE) {
         ...
         #else
         SQUARE_52x20_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
         SQUARE_52x20_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
         SQUARE_52x20_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
         SQUARE_52x20_mb8((int64u*)red_Y, (int64u*)red_Y, (int64u*)modulus, (int64u*)k0);
         #endif
