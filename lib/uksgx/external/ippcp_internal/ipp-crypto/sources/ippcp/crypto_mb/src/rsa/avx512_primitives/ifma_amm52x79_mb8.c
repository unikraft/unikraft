...
void ifma_amm52x79_mb8(int64u *out_mb, const int64u *inpA_mb,
  ...
  U64 res00, res01, res02, res03, res04, res05, res06, res07, res08, res09,
      ...
      res60, res61, res62, res63, res64, res65, res66, res67, res68, res69,
      res70, res71, res72, res73, res74, res75, res76, res77, res78;
  U64 K = loadu64(k0_mb);
  int itr;
                          ...
                          res48 = res49 = res50 = res51 = res52 = res53 =
                              res54 = res55 = res56 = res57 = res58 = res59 =
                                  res60 = res61 = res62 = res63 = res64 =
                                      res65 = res66 = res67 = res68 = res69 =
                                          res70 = res71 = res72 = res73 =
                                              res74 = res75 = res76 = res77 =
                                                  res78 = get_zero64();

  for (itr = 0; itr < 79; itr++) {
    U64 Yi;
    ...
    fma52lo_mem(res60, res60, Bi, inpA_mb, SIMD_BYTES * 60);
    fma52lo_mem(res61, res61, Bi, inpA_mb, SIMD_BYTES * 61);
    fma52lo_mem(res62, res62, Bi, inpA_mb, SIMD_BYTES * 62);
    fma52lo_mem(res63, res63, Bi, inpA_mb, SIMD_BYTES * 63);
    fma52lo_mem(res64, res64, Bi, inpA_mb, SIMD_BYTES * 64);
    fma52lo_mem(res65, res65, Bi, inpA_mb, SIMD_BYTES * 65);
    fma52lo_mem(res66, res66, Bi, inpA_mb, SIMD_BYTES * 66);
    fma52lo_mem(res67, res67, Bi, inpA_mb, SIMD_BYTES * 67);
    fma52lo_mem(res68, res68, Bi, inpA_mb, SIMD_BYTES * 68);
    fma52lo_mem(res69, res69, Bi, inpA_mb, SIMD_BYTES * 69);
    fma52lo_mem(res70, res70, Bi, inpA_mb, SIMD_BYTES * 70);
    fma52lo_mem(res71, res71, Bi, inpA_mb, SIMD_BYTES * 71);
    fma52lo_mem(res72, res72, Bi, inpA_mb, SIMD_BYTES * 72);
    fma52lo_mem(res73, res73, Bi, inpA_mb, SIMD_BYTES * 73);
    fma52lo_mem(res74, res74, Bi, inpA_mb, SIMD_BYTES * 74);
    fma52lo_mem(res75, res75, Bi, inpA_mb, SIMD_BYTES * 75);
    fma52lo_mem(res76, res76, Bi, inpA_mb, SIMD_BYTES * 76);
    fma52lo_mem(res77, res77, Bi, inpA_mb, SIMD_BYTES * 77);
    fma52lo_mem(res78, res78, Bi, inpA_mb, SIMD_BYTES * 78);
    ...
    fma52lo_mem(res60, res60, Yi, inpM_mb, SIMD_BYTES * 60);
    fma52lo_mem(res61, res61, Yi, inpM_mb, SIMD_BYTES * 61);
    fma52lo_mem(res62, res62, Yi, inpM_mb, SIMD_BYTES * 62);
    fma52lo_mem(res63, res63, Yi, inpM_mb, SIMD_BYTES * 63);
    fma52lo_mem(res64, res64, Yi, inpM_mb, SIMD_BYTES * 64);
    fma52lo_mem(res65, res65, Yi, inpM_mb, SIMD_BYTES * 65);
    fma52lo_mem(res66, res66, Yi, inpM_mb, SIMD_BYTES * 66);
    fma52lo_mem(res67, res67, Yi, inpM_mb, SIMD_BYTES * 67);
    fma52lo_mem(res68, res68, Yi, inpM_mb, SIMD_BYTES * 68);
    fma52lo_mem(res69, res69, Yi, inpM_mb, SIMD_BYTES * 69);
    fma52lo_mem(res70, res70, Yi, inpM_mb, SIMD_BYTES * 70);
    fma52lo_mem(res71, res71, Yi, inpM_mb, SIMD_BYTES * 71);
    fma52lo_mem(res72, res72, Yi, inpM_mb, SIMD_BYTES * 72);
    fma52lo_mem(res73, res73, Yi, inpM_mb, SIMD_BYTES * 73);
    fma52lo_mem(res74, res74, Yi, inpM_mb, SIMD_BYTES * 74);
    fma52lo_mem(res75, res75, Yi, inpM_mb, SIMD_BYTES * 75);
    fma52lo_mem(res76, res76, Yi, inpM_mb, SIMD_BYTES * 76);
    fma52lo_mem(res77, res77, Yi, inpM_mb, SIMD_BYTES * 77);
    fma52lo_mem(res78, res78, Yi, inpM_mb, SIMD_BYTES * 78);
    ...
    fma52hi_mem(res59, res60, Bi, inpA_mb, SIMD_BYTES * 59);
    fma52hi_mem(res60, res61, Bi, inpA_mb, SIMD_BYTES * 60);
    fma52hi_mem(res61, res62, Bi, inpA_mb, SIMD_BYTES * 61);
    fma52hi_mem(res62, res63, Bi, inpA_mb, SIMD_BYTES * 62);
    fma52hi_mem(res63, res64, Bi, inpA_mb, SIMD_BYTES * 63);
    fma52hi_mem(res64, res65, Bi, inpA_mb, SIMD_BYTES * 64);
    fma52hi_mem(res65, res66, Bi, inpA_mb, SIMD_BYTES * 65);
    fma52hi_mem(res66, res67, Bi, inpA_mb, SIMD_BYTES * 66);
    fma52hi_mem(res67, res68, Bi, inpA_mb, SIMD_BYTES * 67);
    fma52hi_mem(res68, res69, Bi, inpA_mb, SIMD_BYTES * 68);
    fma52hi_mem(res69, res70, Bi, inpA_mb, SIMD_BYTES * 69);
    fma52hi_mem(res70, res71, Bi, inpA_mb, SIMD_BYTES * 70);
    fma52hi_mem(res71, res72, Bi, inpA_mb, SIMD_BYTES * 71);
    fma52hi_mem(res72, res73, Bi, inpA_mb, SIMD_BYTES * 72);
    fma52hi_mem(res73, res74, Bi, inpA_mb, SIMD_BYTES * 73);
    fma52hi_mem(res74, res75, Bi, inpA_mb, SIMD_BYTES * 74);
    fma52hi_mem(res75, res76, Bi, inpA_mb, SIMD_BYTES * 75);
    fma52hi_mem(res76, res77, Bi, inpA_mb, SIMD_BYTES * 76);
    fma52hi_mem(res77, res78, Bi, inpA_mb, SIMD_BYTES * 77);
    fma52hi_mem(res78, get_zero64(), Bi, inpA_mb, SIMD_BYTES * 78);
    ...
    fma52hi_mem(res60, res60, Yi, inpM_mb, SIMD_BYTES * 60);
    fma52hi_mem(res61, res61, Yi, inpM_mb, SIMD_BYTES * 61);
    fma52hi_mem(res62, res62, Yi, inpM_mb, SIMD_BYTES * 62);
    fma52hi_mem(res63, res63, Yi, inpM_mb, SIMD_BYTES * 63);
    fma52hi_mem(res64, res64, Yi, inpM_mb, SIMD_BYTES * 64);
    fma52hi_mem(res65, res65, Yi, inpM_mb, SIMD_BYTES * 65);
    fma52hi_mem(res66, res66, Yi, inpM_mb, SIMD_BYTES * 66);
    fma52hi_mem(res67, res67, Yi, inpM_mb, SIMD_BYTES * 67);
    fma52hi_mem(res68, res68, Yi, inpM_mb, SIMD_BYTES * 68);
    fma52hi_mem(res69, res69, Yi, inpM_mb, SIMD_BYTES * 69);
    fma52hi_mem(res70, res70, Yi, inpM_mb, SIMD_BYTES * 70);
    fma52hi_mem(res71, res71, Yi, inpM_mb, SIMD_BYTES * 71);
    fma52hi_mem(res72, res72, Yi, inpM_mb, SIMD_BYTES * 72);
    fma52hi_mem(res73, res73, Yi, inpM_mb, SIMD_BYTES * 73);
    fma52hi_mem(res74, res74, Yi, inpM_mb, SIMD_BYTES * 74);
    fma52hi_mem(res75, res75, Yi, inpM_mb, SIMD_BYTES * 75);
    fma52hi_mem(res76, res76, Yi, inpM_mb, SIMD_BYTES * 76);
    fma52hi_mem(res77, res77, Yi, inpM_mb, SIMD_BYTES * 77);
    fma52hi_mem(res78, res78, Yi, inpM_mb, SIMD_BYTES * 78);
  }
  // Normalization
  {
    U64 T = get_zero64();
    ...
    res59 = add64(res59, T);
    T = srli64(res59, DIGIT_SIZE);
    res59 = and64(res59, MASK);
    storeu64(out_mb + MB_WIDTH * 59, res59);
    res60 = add64(res60, T);
    T = srli64(res60, DIGIT_SIZE);
    res60 = and64(res60, MASK);
    storeu64(out_mb + MB_WIDTH * 60, res60);
    res61 = add64(res61, T);
    T = srli64(res61, DIGIT_SIZE);
    res61 = and64(res61, MASK);
    storeu64(out_mb + MB_WIDTH * 61, res61);
    res62 = add64(res62, T);
    T = srli64(res62, DIGIT_SIZE);
    res62 = and64(res62, MASK);
    storeu64(out_mb + MB_WIDTH * 62, res62);
    res63 = add64(res63, T);
    T = srli64(res63, DIGIT_SIZE);
    res63 = and64(res63, MASK);
    storeu64(out_mb + MB_WIDTH * 63, res63);
    res64 = add64(res64, T);
    T = srli64(res64, DIGIT_SIZE);
    res64 = and64(res64, MASK);
    storeu64(out_mb + MB_WIDTH * 64, res64);
    res65 = add64(res65, T);
    T = srli64(res65, DIGIT_SIZE);
    res65 = and64(res65, MASK);
    storeu64(out_mb + MB_WIDTH * 65, res65);
    res66 = add64(res66, T);
    T = srli64(res66, DIGIT_SIZE);
    res66 = and64(res66, MASK);
    storeu64(out_mb + MB_WIDTH * 66, res66);
    res67 = add64(res67, T);
    T = srli64(res67, DIGIT_SIZE);
    res67 = and64(res67, MASK);
    storeu64(out_mb + MB_WIDTH * 67, res67);
    res68 = add64(res68, T);
    T = srli64(res68, DIGIT_SIZE);
    res68 = and64(res68, MASK);
    storeu64(out_mb + MB_WIDTH * 68, res68);
    res69 = add64(res69, T);
    T = srli64(res69, DIGIT_SIZE);
    res69 = and64(res69, MASK);
    storeu64(out_mb + MB_WIDTH * 69, res69);
    res70 = add64(res70, T);
    T = srli64(res70, DIGIT_SIZE);
    res70 = and64(res70, MASK);
    storeu64(out_mb + MB_WIDTH * 70, res70);
    res71 = add64(res71, T);
    T = srli64(res71, DIGIT_SIZE);
    res71 = and64(res71, MASK);
    storeu64(out_mb + MB_WIDTH * 71, res71);
    res72 = add64(res72, T);
    T = srli64(res72, DIGIT_SIZE);
    res72 = and64(res72, MASK);
    storeu64(out_mb + MB_WIDTH * 72, res72);
    res73 = add64(res73, T);
    T = srli64(res73, DIGIT_SIZE);
    res73 = and64(res73, MASK);
    storeu64(out_mb + MB_WIDTH * 73, res73);
    res74 = add64(res74, T);
    T = srli64(res74, DIGIT_SIZE);
    res74 = and64(res74, MASK);
    storeu64(out_mb + MB_WIDTH * 74, res74);
    res75 = add64(res75, T);
    T = srli64(res75, DIGIT_SIZE);
    res75 = and64(res75, MASK);
    storeu64(out_mb + MB_WIDTH * 75, res75);
    res76 = add64(res76, T);
    T = srli64(res76, DIGIT_SIZE);
    res76 = and64(res76, MASK);
    storeu64(out_mb + MB_WIDTH * 76, res76);
    res77 = add64(res77, T);
    T = srli64(res77, DIGIT_SIZE);
    res77 = and64(res77, MASK);
    storeu64(out_mb + MB_WIDTH * 77, res77);
    res78 = add64(res78, T);
    res78 = and64(res78, MASK);
    storeu64(out_mb + MB_WIDTH * 78, res78);
  }
}
