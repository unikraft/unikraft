...
%endif
extern m7_ippsGFpECSetPointOctString%+elf_symbol_type
extern n8_ippsGFpECSetPointOctString%+elf_symbol_type
extern y8_ippsGFpECSetPointOctString%+elf_symbol_type
extern e9_ippsGFpECSetPointOctString%+elf_symbol_type
extern l9_ippsGFpECSetPointOctString%+elf_symbol_type
extern n0_ippsGFpECSetPointOctString%+elf_symbol_type
extern k0_ippsGFpECSetPointOctString%+elf_symbol_type
extern k1_ippsGFpECSetPointOctString%+elf_symbol_type
...
.Larraddr_ippsGFpECSetPointOctString:
    ...
    dq k1_ippsGFpECSetPointOctString
