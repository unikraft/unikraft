...
%endif
extern m7_ippsHashUpdate_rmf%+elf_symbol_type
extern n8_ippsHashUpdate_rmf%+elf_symbol_type
extern y8_ippsHashUpdate_rmf%+elf_symbol_type
extern e9_ippsHashUpdate_rmf%+elf_symbol_type
extern l9_ippsHashUpdate_rmf%+elf_symbol_type
extern n0_ippsHashUpdate_rmf%+elf_symbol_type
extern k0_ippsHashUpdate_rmf%+elf_symbol_type
extern k1_ippsHashUpdate_rmf%+elf_symbol_type
