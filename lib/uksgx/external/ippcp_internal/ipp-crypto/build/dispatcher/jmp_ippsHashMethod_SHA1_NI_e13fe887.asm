...
%endif
extern m7_ippsHashMethod_SHA1_NI%+elf_symbol_type
extern n8_ippsHashMethod_SHA1_NI%+elf_symbol_type
extern y8_ippsHashMethod_SHA1_NI%+elf_symbol_type
extern e9_ippsHashMethod_SHA1_NI%+elf_symbol_type
extern l9_ippsHashMethod_SHA1_NI%+elf_symbol_type
extern n0_ippsHashMethod_SHA1_NI%+elf_symbol_type
extern k0_ippsHashMethod_SHA1_NI%+elf_symbol_type
extern k1_ippsHashMethod_SHA1_NI%+elf_symbol_type
