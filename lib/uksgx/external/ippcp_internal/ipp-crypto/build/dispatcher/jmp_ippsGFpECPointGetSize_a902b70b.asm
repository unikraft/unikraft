...
%endif
extern m7_ippsGFpECPointGetSize%+elf_symbol_type
extern n8_ippsGFpECPointGetSize%+elf_symbol_type
extern y8_ippsGFpECPointGetSize%+elf_symbol_type
extern e9_ippsGFpECPointGetSize%+elf_symbol_type
extern l9_ippsGFpECPointGetSize%+elf_symbol_type
extern n0_ippsGFpECPointGetSize%+elf_symbol_type
extern k0_ippsGFpECPointGetSize%+elf_symbol_type
extern k1_ippsGFpECPointGetSize%+elf_symbol_type
