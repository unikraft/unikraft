...
%endif
extern m7_ippsECCGetResultString%+elf_symbol_type
extern n8_ippsECCGetResultString%+elf_symbol_type
extern y8_ippsECCGetResultString%+elf_symbol_type
extern e9_ippsECCGetResultString%+elf_symbol_type
extern l9_ippsECCGetResultString%+elf_symbol_type
extern n0_ippsECCGetResultString%+elf_symbol_type
extern k0_ippsECCGetResultString%+elf_symbol_type
extern k1_ippsECCGetResultString%+elf_symbol_type
