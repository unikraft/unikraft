...
%endif
extern m7_ippsRSASign_PSS_rmf%+elf_symbol_type
extern n8_ippsRSASign_PSS_rmf%+elf_symbol_type
extern y8_ippsRSASign_PSS_rmf%+elf_symbol_type
extern e9_ippsRSASign_PSS_rmf%+elf_symbol_type
extern l9_ippsRSASign_PSS_rmf%+elf_symbol_type
extern n0_ippsRSASign_PSS_rmf%+elf_symbol_type
extern k0_ippsRSASign_PSS_rmf%+elf_symbol_type
extern k1_ippsRSASign_PSS_rmf%+elf_symbol_type
