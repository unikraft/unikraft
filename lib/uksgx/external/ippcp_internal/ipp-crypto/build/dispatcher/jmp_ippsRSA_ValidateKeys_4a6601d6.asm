...
%endif
extern m7_ippsRSA_ValidateKeys%+elf_symbol_type
extern n8_ippsRSA_ValidateKeys%+elf_symbol_type
extern y8_ippsRSA_ValidateKeys%+elf_symbol_type
extern e9_ippsRSA_ValidateKeys%+elf_symbol_type
extern l9_ippsRSA_ValidateKeys%+elf_symbol_type
extern n0_ippsRSA_ValidateKeys%+elf_symbol_type
extern k0_ippsRSA_ValidateKeys%+elf_symbol_type
extern k1_ippsRSA_ValidateKeys%+elf_symbol_type
