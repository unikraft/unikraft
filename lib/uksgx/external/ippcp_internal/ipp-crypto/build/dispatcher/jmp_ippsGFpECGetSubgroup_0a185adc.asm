...
%endif
extern m7_ippsGFpECGetSubgroup%+elf_symbol_type
extern n8_ippsGFpECGetSubgroup%+elf_symbol_type
extern y8_ippsGFpECGetSubgroup%+elf_symbol_type
extern e9_ippsGFpECGetSubgroup%+elf_symbol_type
extern l9_ippsGFpECGetSubgroup%+elf_symbol_type
extern n0_ippsGFpECGetSubgroup%+elf_symbol_type
extern k0_ippsGFpECGetSubgroup%+elf_symbol_type
extern k1_ippsGFpECGetSubgroup%+elf_symbol_type
