...
%endif
extern m7_ippsTRNGenRDSEED_BN%+elf_symbol_type
extern n8_ippsTRNGenRDSEED_BN%+elf_symbol_type
extern y8_ippsTRNGenRDSEED_BN%+elf_symbol_type
extern e9_ippsTRNGenRDSEED_BN%+elf_symbol_type
extern l9_ippsTRNGenRDSEED_BN%+elf_symbol_type
extern n0_ippsTRNGenRDSEED_BN%+elf_symbol_type
extern k0_ippsTRNGenRDSEED_BN%+elf_symbol_type
extern k1_ippsTRNGenRDSEED_BN%+elf_symbol_type
