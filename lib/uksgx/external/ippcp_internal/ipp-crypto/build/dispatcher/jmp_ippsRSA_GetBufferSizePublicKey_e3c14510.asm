...
%endif
extern m7_ippsRSA_GetBufferSizePublicKey%+elf_symbol_type
extern n8_ippsRSA_GetBufferSizePublicKey%+elf_symbol_type
extern y8_ippsRSA_GetBufferSizePublicKey%+elf_symbol_type
extern e9_ippsRSA_GetBufferSizePublicKey%+elf_symbol_type
extern l9_ippsRSA_GetBufferSizePublicKey%+elf_symbol_type
extern n0_ippsRSA_GetBufferSizePublicKey%+elf_symbol_type
extern k0_ippsRSA_GetBufferSizePublicKey%+elf_symbol_type
extern k1_ippsRSA_GetBufferSizePublicKey%+elf_symbol_type
...
.Larraddr_ippsRSA_GetBufferSizePublicKey:
    ...
    dq k1_ippsRSA_GetBufferSizePublicKey
