...
%endif
extern m7_ippsAES_GCMGetSize%+elf_symbol_type
extern n8_ippsAES_GCMGetSize%+elf_symbol_type
extern y8_ippsAES_GCMGetSize%+elf_symbol_type
extern e9_ippsAES_GCMGetSize%+elf_symbol_type
extern l9_ippsAES_GCMGetSize%+elf_symbol_type
extern n0_ippsAES_GCMGetSize%+elf_symbol_type
extern k0_ippsAES_GCMGetSize%+elf_symbol_type
extern k1_ippsAES_GCMGetSize%+elf_symbol_type
