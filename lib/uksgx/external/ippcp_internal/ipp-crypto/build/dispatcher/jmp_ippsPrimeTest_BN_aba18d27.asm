...
%endif
extern m7_ippsPrimeTest_BN%+elf_symbol_type
extern n8_ippsPrimeTest_BN%+elf_symbol_type
extern y8_ippsPrimeTest_BN%+elf_symbol_type
extern e9_ippsPrimeTest_BN%+elf_symbol_type
extern l9_ippsPrimeTest_BN%+elf_symbol_type
extern n0_ippsPrimeTest_BN%+elf_symbol_type
extern k0_ippsPrimeTest_BN%+elf_symbol_type
extern k1_ippsPrimeTest_BN%+elf_symbol_type
