...
%endif
extern m7_ippsECCPVerifyDSA%+elf_symbol_type
extern n8_ippsECCPVerifyDSA%+elf_symbol_type
extern y8_ippsECCPVerifyDSA%+elf_symbol_type
extern e9_ippsECCPVerifyDSA%+elf_symbol_type
extern l9_ippsECCPVerifyDSA%+elf_symbol_type
extern n0_ippsECCPVerifyDSA%+elf_symbol_type
extern k0_ippsECCPVerifyDSA%+elf_symbol_type
extern k1_ippsECCPVerifyDSA%+elf_symbol_type
