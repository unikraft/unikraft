...
%endif
extern m7_ippsSMS4DecryptCBC%+elf_symbol_type
extern n8_ippsSMS4DecryptCBC%+elf_symbol_type
extern y8_ippsSMS4DecryptCBC%+elf_symbol_type
extern e9_ippsSMS4DecryptCBC%+elf_symbol_type
extern l9_ippsSMS4DecryptCBC%+elf_symbol_type
extern n0_ippsSMS4DecryptCBC%+elf_symbol_type
extern k0_ippsSMS4DecryptCBC%+elf_symbol_type
extern k1_ippsSMS4DecryptCBC%+elf_symbol_type
