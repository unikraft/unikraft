...
*F*/
IPPFUN(IppStatus, ippsRSADecrypt_OAEP,(const Ipp8u* pSrc,
      ...
      */
      {
         ...
         ippsMGF(pMaskedSeed, hashLen, pDB, k-1-hashLen, hashAlg);
         XorBlock(pMaskedDB, pDB, pMaskedDB, k-1-hashLen);

         ippsHashMessage(pLab, labLen, seedMask, hashAlg);
