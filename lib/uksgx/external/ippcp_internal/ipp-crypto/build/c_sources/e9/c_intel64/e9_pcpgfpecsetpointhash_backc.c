...
/*F*
// Name: ippsGFpECSetPointHashBackCompatible
//
...
IPPFUN(IppStatus, ippsGFpECSetPointHashBackCompatible,(Ipp32u hdr, const Ipp8u* pMsg, int msgLen, IppsGFpECPoint* pPoint,
