 ...
 *   Data represented as 2 40-qwords arrays in 2^52-radix.
 *
 */
IPP_OWN_DEFN(void, ifma256_amm52x40_dual, (Ipp64u out[2][40],
                                     const Ipp64u a  [2][40],
                                     const Ipp64u b  [2][40],
                                     const Ipp64u m  [2][40],
                                     const Ipp64u k0 [2]))
{
    ...
    Ipp64u a0_0   = a_0[0];
    Ipp64u acc0_0 = 0;
    U64 R0_0, R1_0, R2_0, R3_0, R4_0, R0_0h, R1_0h, R2_0h, R3_0h, R4_0h;
    R0_0 = R1_0 = R2_0 = R3_0 = R4_0 = R0_0h = R1_0h = R2_0h = R3_0h = R4_0h = get_zero64();
    ...
    Ipp64u a0_1   = a_1[0];
    Ipp64u acc0_1 = 0;
    U64 R0_1, R1_1, R2_1, R3_1, R4_1, R0_1h, R1_1h, R2_1h, R3_1h, R4_1h;
    R0_1 = R1_1 = R2_1 = R3_1 = R4_1 = R0_1h = R1_1h = R2_1h = R3_1h = R4_1h = get_zero64();
    ...
    for (i=0; i<40; i++) {
        {
            ...
            fma52x8lo_mem(R2_0, R2_0, Bi, a_0, 64*2)
            fma52x8lo_mem(R3_0, R3_0, Bi, a_0, 64*3)
            fma52x8lo_mem(R4_0, R4_0, Bi, a_0, 64*4)

            fma52x8lo_mem(R0_0, R0_0, Yi, m_0, 64*0)
            fma52x8lo_mem(R1_0, R1_0, Yi, m_0, 64*1)
            fma52x8lo_mem(R2_0, R2_0, Yi, m_0, 64*2)
            fma52x8lo_mem(R3_0, R3_0, Yi, m_0, 64*3)
            fma52x8lo_mem(R4_0, R4_0, Yi, m_0, 64*4)

            shift64_imm(R0_0, R0_0h, 1)
            shift64_imm(R0_0h, R1_0, 1)
            shift64_imm(R1_0, R1_0h, 1)
            shift64_imm(R1_0h, R2_0, 1)
            shift64_imm(R2_0, R2_0h, 1)
            shift64_imm(R2_0h, R3_0, 1)
            shift64_imm(R3_0, R3_0h, 1)
            shift64_imm(R3_0h, R4_0, 1)
            shift64_imm(R4_0, R4_0h, 1)
            shift64_imm(R4_0h, get_zero64(), 1)
            ...
            fma52x8hi_mem(R2_0, R2_0, Bi, a_0, 64*2)
            fma52x8hi_mem(R3_0, R3_0, Bi, a_0, 64*3)
            fma52x8hi_mem(R4_0, R4_0, Bi, a_0, 64*4)
            /* R += M*Yi (hi) */
            fma52x8hi_mem(R0_0, R0_0, Yi, m_0, 64*0)
            fma52x8hi_mem(R1_0, R1_0, Yi, m_0, 64*1)
            fma52x8hi_mem(R2_0, R2_0, Yi, m_0, 64*2)
            fma52x8hi_mem(R3_0, R3_0, Yi, m_0, 64*3)
            fma52x8hi_mem(R4_0, R4_0, Yi, m_0, 64*4)
        }
        {
            Ipp64u t0, t1, t2, yi;
            ...
            fma52x8lo_mem(R2_1, R2_1, Bi, a_1, 64*2)
            fma52x8lo_mem(R3_1, R3_1, Bi, a_1, 64*3)
            fma52x8lo_mem(R4_1, R4_1, Bi, a_1, 64*4)

            fma52x8lo_mem(R0_1, R0_1, Yi, m_1, 64*0)
            fma52x8lo_mem(R1_1, R1_1, Yi, m_1, 64*1)
            fma52x8lo_mem(R2_1, R2_1, Yi, m_1, 64*2)
            fma52x8lo_mem(R3_1, R3_1, Yi, m_1, 64*3)
            fma52x8lo_mem(R4_1, R4_1, Yi, m_1, 64*4)

            shift64_imm(R0_1, R0_1h, 1)
            shift64_imm(R0_1h, R1_1, 1)
            shift64_imm(R1_1, R1_1h, 1)
            shift64_imm(R1_1h, R2_1, 1)
            shift64_imm(R2_1, R2_1h, 1)
            shift64_imm(R2_1h, R3_1, 1)
            shift64_imm(R3_1, R3_1h, 1)
            shift64_imm(R3_1h, R4_1, 1)
            shift64_imm(R4_1, R4_1h, 1)
            shift64_imm(R4_1h, get_zero64(), 1)
            ...
            fma52x8hi_mem(R2_1, R2_1, Bi, a_1, 64*2)
            fma52x8hi_mem(R3_1, R3_1, Bi, a_1, 64*3)
            fma52x8hi_mem(R4_1, R4_1, Bi, a_1, 64*4)
            /* R += M*Yi (hi) */
            fma52x8hi_mem(R0_1, R0_1, Yi, m_1, 64*0)
            fma52x8hi_mem(R1_1, R1_1, Yi, m_1, 64*1)
            fma52x8hi_mem(R2_1, R2_1, Yi, m_1, 64*2)
            fma52x8hi_mem(R3_1, R3_1, Yi, m_1, 64*3)
            fma52x8hi_mem(R4_1, R4_1, Yi, m_1, 64*4)
        }
    }
    {
        ...
        NORMALIZE_52x40(R0_0, R1_0, R2_0, R3_0, R4_0)
        ...
        storeu64(out[0] + 5*4, R2_0h);
        storeu64(out[0] + 6*4, R3_0);
        storeu64(out[0] + 7*4, R3_0h);
        storeu64(out[0] + 8*4, R4_0);
        storeu64(out[0] + 9*4, R4_0h);
    }
    {
        ...
        NORMALIZE_52x40(R0_1, R1_1, R2_1, R3_1, R4_1)
        ...
        storeu64(out[1] + 5*4, R2_1h);
        storeu64(out[1] + 6*4, R3_1);
        storeu64(out[1] + 7*4, R3_1h);
        storeu64(out[1] + 8*4, R4_1);
        storeu64(out[1] + 9*4, R4_1h);
    }
}

IPP_OWN_DEFN(void, ifma256_ams52x40_dual, (Ipp64u out[2][40],
                                     const Ipp64u a  [2][40],
                                     const Ipp64u m  [2][40],
                                     const Ipp64u k0 [2]))
{
    ifma256_amm52x40_dual(out, a, a, m, k0);
}
