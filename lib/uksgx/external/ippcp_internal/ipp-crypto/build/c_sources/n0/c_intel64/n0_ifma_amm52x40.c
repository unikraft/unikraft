 ...
 *
 *   Data represented as 40-qwords arrays in 2^52-radix.
 *
 */
IPP_OWN_DEFN(void, ifma256_amm52x40, (Ipp64u out[40],
                                const Ipp64u a  [40],
                                const Ipp64u b  [40],
                                const Ipp64u m  [40],
                                      Ipp64u k0))
...
IPP_OWN_DEFN(void, ifma256_ams52x40, (Ipp64u out[40],
                                const Ipp64u a  [40],
                                const Ipp64u m  [40],
                                      Ipp64u k0))
{
    ifma256_amm52x40(out, a, a, m, k0);
}
