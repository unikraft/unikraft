 ...
 *   Data represented as 2 (30+2)-qwords arrays in 2^52-radix.
 *
 *   Note: 2 high qwords - zero padding.
 *
 */
IPP_OWN_DEFN(void, ifma256_amm52x30_dual, (Ipp64u out[2][32],
                                     const Ipp64u a  [2][32],
                                     const Ipp64u b  [2][32],
                                     const Ipp64u m  [2][32],
                                     const Ipp64u k0 [2]))
{
    ...
    Ipp64u a0_0   = a_0[0];
    Ipp64u acc0_0 = 0;
    U64 R0_0, R1_0, R2_0, R3_0, R0_0h, R1_0h, R2_0h, R3_0h;
    R0_0 = R1_0 = R2_0 = R3_0 = R0_0h = R1_0h = R2_0h = R3_0h = get_zero64();
    ...
    Ipp64u a0_1   = a_1[0];
    Ipp64u acc0_1 = 0;
    U64 R0_1, R1_1, R2_1, R3_1, R0_1h, R1_1h, R2_1h, R3_1h;
    R0_1 = R1_1 = R2_1 = R3_1 = R0_1h = R1_1h = R2_1h = R3_1h = get_zero64();
    ...
    for (i=0; i<30; i++) {
        {
            ...
            shift64_imm(R3_0h, get_zero64(), 1)
        ...
        }
        {
            ...
            shift64_imm(R3_1h, get_zero64(), 1)
    ...
    }
    {
        ...
        NORMALIZE_52x30(R0_0, R1_0, R2_0, R3_0)
    ...
    }
    {
        ...
        NORMALIZE_52x30(R0_1, R1_1, R2_1, R3_1)
...
IPP_OWN_DEFN(void, ifma256_ams52x30_dual, (Ipp64u out[2][32],
                                     const Ipp64u a  [2][32],
                                     const Ipp64u m  [2][32],
                                     const Ipp64u k0 [2]))
{
    ifma256_amm52x30_dual(out, a, a, m, k0);
}
