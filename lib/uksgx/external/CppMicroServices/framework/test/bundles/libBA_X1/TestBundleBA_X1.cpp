...
#include "TestBundleBA_X1Service.h"
...
struct TestBundleBA_X1 : public TestBundleBA_X1Service
{

  TestBundleBA_X1() {}
  virtual ~TestBundleBA_X1() {}
};
...
private:
  ServiceRegistration<TestBundleBA_X1Service> sr;
};
}
