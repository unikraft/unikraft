...
def generate_doxygen_xml(app):
    """Run the doxygen command to generate XML info"""

    try:
        # Read in the file
        filedata = None
        with open('doc/doxygen-breathe.conf', 'r') as file :
            filedata = file.read()

        cwd = os.getcwd()

        # Replace the target string
        filedata = filedata.replace('@SOURCE_DIR@', cwd)
...
# ones.
extensions = ['breathe', 'cmake']

breathe_projects = { "us": "doc/_api/xml/" }
...
#
# html_title = u'CppMicroServices v3.0'
...
htmlhelp_basename = 'CppMicroServicesdoc'
...
latex_documents = [
    (master_doc, 'CppMicroServices.tex', u'CppMicroServices Documentation',
     u'CppMicroServices Contributors', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'CppMicroServices', u'CppMicroServices Documentation',
     author, 'CppMicroServices', 'An OSGi-like C++ dynamic module system and service registry.',
     'Miscellaneous'),
]
