BEGIN {
	...
	print "UK_SYSCALL_EXECENV_PROLOGUE_DEFINE(uk_syscall6_r, uk_syscall6_r_u,"
	print "\t\t\t\t14, long, nr, long, arg1, long, arg2, long, arg3, long, arg4, long, arg5, long, arg6)";
	print "\nlong __used uk_syscall6_r_u(struct ukarch_execenv *execenv)"
	print "{"
	print "\tlong ret;"
	print "\n\tswitch (execenv->regs.rsyscall) {"
}
...
/[a-zA-Z0-9]+-[0-9]+/{
	...
	for (i = 0; i < args_nr - 1; i++)
		printf("execenv->regs.rarg%d, ", i)
	if (args_nr > 0)
		printf("execenv->regs.rarg%d", args_nr - 1)
	printf(");\n")
